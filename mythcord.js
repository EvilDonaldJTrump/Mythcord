...
client.on('ready', () => {
    ...
    setInterval(() => {
        ...
        const onTypeInterval = Math.floor(Math.random() * (activity.type.length - 1) + 1);
        client.user.setActivity(activity.activities[onInterval], {type: activity.type[onTypeInterval]});
    }, 11000);
